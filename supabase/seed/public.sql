...
-- \restrict D5S7YCoHN9zZcmdV6ncBrQ7kOtf1ABkjDYPmjuaOtBNRgsrgNLEoWSgCf3wuY0W
...
INSERT INTO "public"."pool_closure_analysis" ("id", "pool_update_id", "closure_date", "reasoning", "confidence_score", "reopening_date", "created_at", "flags", "updated_at") VALUES
	...
	('6fd7d1d6-81ce-4d2b-a3d1-1ef1e00d886f', '6afb352f-bbe7-5bbc-a0b0-a39140549f7d', NULL, 'The update explicitly states the pool is currently open with no closure information.', 100, NULL, '2026-05-27 17:53:41.978317+00', '{}', '2026-05-28 19:50:23.488135+00'),
	('9b810422-d161-4a12-9641-7a6ada8fe273', 'ae81b225-e66b-57af-97d2-1c3a92ae3547', NULL, 'The update indicates a schedule change effective on June 1st but does not explicitly state whether this is for seasonal operations or just hour adjustments. Without explicit mention of opening or closing season status, dates are withheld to avoid assumptions.', 65, NULL, '2026-05-31 00:25:02.576407+00', '{status_ambiguous}', '2026-06-06 18:47:41.034935+00');
...
-- \unrestrict D5S7YCoHN9zZcmdV6ncBrQ7kOtf1ABkjDYPmjuaOtBNRgsrgNLEoWSgCf3wuY0W
